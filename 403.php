...
<html lang="en">
  ...
  <body id="top">
    ...
    <!-- main -->
    <main>
      <section class="section error" id="error" aria-label="403 error"
        ...
        <h1 data-translation
          ...
          data-lang-eng="403" data-lang-ban="৪০৩">403</h1>
        <h2 data-translation
          style="font-size:2.4rem;color:var(--oxford-red-1);margin:10px 0 20px;"
          data-lang-eng="Forbidden"
          data-lang-ban="প্রবেশ নিষিদ্ধ">Forbidden</h2>
        <p class="card-text" data-translation
          style="max-width:500px;margin-bottom:30px;"
          data-lang-eng="You do not have permission to access this page."
