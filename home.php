...
$footer_text_en = $site['footer_text_en'] ?? "One of the best physiotherapy center in Dhaka city. Feel better, move easier, and get back to living your life with simple and effective physiotherapy care.";
...
$google_sheet_phone_url = $site['google_sheet_phone_url'] ?? '';
...
<html lang="en">
  <head>
    ...
    <meta name="keywords" id="meta-keywords" content="adporc, asia digital physiotherapy, asia digital physiotherapy orthopedic rehabilitation center, dr saddam hossain, 
          best physiotherapy dhaka, best physiotherapy jatrabari, best physiotherapy dholaipar, best physiotherapy shonir akhra, best physiotherapy doyagonj, best physiotherapy mirhazirbag, best physiotherapy saydabad, best physiotherapy doyagonj, best physiotherapy jurain, best physiotherapy hasnabad, best physiotherapy puran dhaka, best physiotherapy narayanganj, ফিজিওথেরাপি যাত্রাবাড়ী, ঢাকায় সেরা ফিজিওথেরাপি">
        ...
        <section class="section hero" id="home"
          ...
          <div class="container">
            <div class="hero-content">
              ...
              <form id="phoneForm" class="hero-form" action="<?= h($google_sheet_phone_url) ?>">
        ...
        <section class="section blog" id="blog" aria-label="blog">
          <div class="container">
            ...
            <div class="blog-load-more-wrap">
              <a href="/blogs" class="btn" data-translation data-lang-eng="See more blogs" data-lang-ban="আরও ব্লগ দেখুন">See more blogs</a>
            </div>
          </div>
        </section>
      </article>
