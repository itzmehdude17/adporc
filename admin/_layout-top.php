...
<div class="admin-layout">
  ...
  <aside class="sidebar" id="adminSidebar">
    <div class="sidebar-header">
      <div class="sidebar-logo">ADPORC<span></span></div>
    ...
    <nav class="sidebar-nav">
      ...
      <a href="/admin/page-editor.php" <?= in_array(basename($_SERVER['PHP_SELF']), ['page-editor.php','home-editor.php']) ? 'class="active"' : '' ?>>
      ...
      <a href="/admin/users.php" <?= basename($_SERVER['PHP_SELF']) === 'users.php' ? 'class="active"' : '' ?>>
  ...
  <div class="admin-main">
    <div class="admin-topbar">
      ...
      <div class="topbar-actions">
        ...
        <span class="topbar-user">Logged in as <strong><?= h($_SESSION['admin_username'] ?? 'Admin') ?></strong><?php if (($_SESSION['admin_role'] ?? '') === 'master'): ?> <span class="badge-role master" style="font-size:.65rem;padding:1px 6px;">Master</span><?php endif; ?></span>
      </div>
    </div>
