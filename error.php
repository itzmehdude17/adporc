...
if (!in_array($code, [401, 403, 404, 500])) $code = 500;
http_response_code($code);

$errors = [
    401 => [
        'en_code' => '401', 'bn_code' => '৪০১',
        'en_title' => 'Unauthorized', 'bn_title' => 'অননুমোদিত',
        'en_msg'   => 'You are not authorized to access this page. Please log in and try again.',
        'bn_msg'   => 'আপনি এই পৃষ্ঠায় প্রবেশ করতে অনুমোদিত নন। অনুগ্রহ করে লগইন করে আবার চেষ্টা করুন।',
        'show_login' => true,
    ],
    403 => [
        'en_code' => '403', 'bn_code' => '৪০৩',
        'en_title' => 'Forbidden', 'bn_title' => 'প্রবেশ নিষিদ্ধ',
        'en_msg'   => 'You do not have permission to access this page.',
        'bn_msg'   => 'আপনার এই পৃষ্ঠায় প্রবেশ করার অনুমতি নেই।',
        'show_login' => false,
    ],
    404 => [
        'en_code' => '404', 'bn_code' => '৪০৪',
        'en_title' => 'Page Not Found', 'bn_title' => 'পৃষ্ঠা পাওয়া যায়নি',
        'en_msg'   => 'Sorry, the page you are looking for does not exist or you may have entered the wrong link.',
        'bn_msg'   => 'দুঃখিত, আপনি যে পৃষ্ঠাটি খুঁজছেন তা নেই অথবা ভুল লিংকে প্রবেশ করেছেন।',
        'show_login' => false,
    ],
    500 => [
        'en_code' => '500', 'bn_code' => '৫০০',
        'en_title' => 'Internal Server Error', 'bn_title' => 'সার্ভার ত্রুটি',
        'en_msg'   => 'Oops! Something went wrong on our end. Please try again in a moment.',
        'bn_msg'   => 'দুঃখিত, আমাদের সার্ভারে একটি সমস্যা হয়েছে। অনুগ্রহ করে কিছুক্ষণ পরে আবার চেষ্টা করুন।',
        'show_login' => false,
    ],
];
...
<html lang="en">
  <head>
    ...
    <title><?= h($e['en_code']) ?> <?= h($e['en_title']) ?> | ADPORC</title>
    <!-- css -->
  ...
  <body id="top">
    ...
    <!-- main -->
    <main>
      <section class="section" id="error" aria-label="error page"
        ...
        <h1 data-translation
          ...
          data-lang-eng="<?= h($e['en_code']) ?>"
          data-lang-ban="<?= h($e['bn_code']) ?>"><?= h($e['en_code']) ?></h1>
        <h2 data-translation
          style="font-size:2.4rem;color:var(--oxford-red-1);margin:10px 0 20px;"
          data-lang-eng="<?= h($e['en_title']) ?>"
          data-lang-ban="<?= h($e['bn_title']) ?>"><?= h($e['en_title']) ?></h2>
        <p class="card-text" data-translation
          style="max-width:500px;margin-bottom:30px;"
          data-lang-eng="<?= h($e['en_msg']) ?>"
          data-lang-ban="<?= h($e['bn_msg']) ?>"><?= h($e['en_msg']) ?></p>
        <div style="display:flex;gap:15px;flex-wrap:wrap;justify-content:center;margin-top:10px;">
          <?php if ($e['show_login']): ?>
          <a href="/admin" class="btn" data-translation
            data-lang-eng="Go to Login" data-lang-ban="লগইনে যান">Go to Login</a>
          <?php endif; ?>
          <a href="/home" class="btn" <?= $e['show_login'] ? 'style="background-image:none;background-color:var(--oxford-red-2);"' : '' ?>
