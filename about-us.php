...
$about_page = loadJson('about.json')       ?: [];
...
// About page content with fallbacks
$ap_banner     = $about_page['banner']      ?? '/assets/images/banners/banner-6.jpeg';
$ap_subtitle_en= $about_page['subtitle_en'] ?? 'About Us';
$ap_subtitle_bn= $about_page['subtitle_bn'] ?? 'আমাদের সম্পর্কে';
$ap_title_en   = $about_page['title_en']    ?? 'Asia Digital Physiotherapy and Orthopedic Rehabilitation Center (ADPORC)';
$ap_title_bn   = $about_page['title_bn']    ?? 'এশিয়া ডিজিটাল ফিজিওথেরাপি এন্ড অর্থোপেডিক রিহ্যাবিলিটেশন সেন্টার';
$ap_text1_en   = $about_page['text1_en']    ?? '';
$ap_text1_bn   = $about_page['text1_bn']    ?? '';
$ap_text2_en   = $about_page['text2_en']    ?? '';
$ap_text2_bn   = $about_page['text2_bn']    ?? '';
$ap_text3_en   = $about_page['text3_en']    ?? '';
$ap_text3_bn   = $about_page['text3_bn']    ?? '';
?>
<!-- itzmehdude -->
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <meta name="description" content="Learn about ADPORC — Asia Digital Physiotherapy & Orthopedic Rehabilitation Center in Dhaka. Led by Dr. Saddam Hossain. Visit our branches in Jatrabari and Shonir Akhra.">
    <meta name="keywords" content="adporc, asia digital physiotherapy, about adporc, physiotherapy center dhaka, dr saddam hossain, best physiotherapy jatrabari, best physiotherapy shonir akhra, physiotherapy center jatrabari">
    ...
    <meta property="og:description" content="Learn about ADPORC — the best physiotherapy center in Jatrabari, Dhaka. Expert care led by Dr. Saddam Hossain.">
    ...
    <script type="application/ld+json">
    {
      ...
      "@graph": [
        { "@type": "WebSite", "name": "ADPORC", "url": "https://adporc.com" },
        {
          ...
          "description": "Asia Digital Physiotherapy & Orthopedic Rehabilitation Center — trusted physiotherapy care in Dhaka.",
      ...
      <section class="section about" id="about">
        <div class="container">
          <figure class="about-banner">
            <img src="<?= h($ap_banner) ?>" width="470" height="538" loading="lazy" alt="ADPORC physiotherapy center" class="w-100">
          </figure>
          <div class="about-content">
            <p class="section-subtitle text-center" data-translation
              data-lang-eng="<?= h($ap_subtitle_en) ?>"
              data-lang-ban="<?= h($ap_subtitle_bn) ?>"></p>
            <h1 class="h2 section-title" data-translation
              data-lang-eng="<?= h($ap_title_en) ?>"
              data-lang-ban="<?= h($ap_title_bn) ?>"></h1>
            <p class="section-text section-text-1" data-translation
              data-lang-eng="<?= h($ap_text1_en) ?>"
              data-lang-ban="<?= h($ap_text1_bn) ?>"></p>
            <p class="section-text section-text-1" data-translation
              data-lang-eng="<?= h($ap_text2_en) ?>"
              data-lang-ban="<?= h($ap_text2_bn) ?>"></p>
            <h2 class="section-text" data-translation
              data-lang-eng="We specialize in:"
              data-lang-ban="আমাদের মূল চিকিৎসা ক্ষেত্র"></h2>
            <ol class="section-text" id="blog-en">
              ...
              <li>Advanced electrotherapy for faster, evidence-based recovery</li>
            ...
            <p class="section-text section-text-1" data-translation
              data-lang-eng="<?= h($ap_text3_en) ?>"
              data-lang-ban="<?= h($ap_text3_bn) ?>"></p>
          </div>
        </div>
      </section>

      <!-- our branches section -->
      <section class="section about" id="branches">
        <div class="container">
          <p class="section-subtitle text-center" data-translation
            data-lang-eng="Our Branches"
            data-lang-ban="আমাদের শাখা সমূহ">Our Branches</p>
          <p class="section-text section-text-1" data-translation
            data-lang-eng="Visit any of our branches for advanced physiotherapy care."
          ...
          <div class="branch">
            <div class="branch-content">
              <h2 class="h3 branch-title" data-translation
                data-lang-eng="ADPORC | Main Branch"
                data-lang-ban="ADPORC | প্রধান শাখা">ADPORC | Main Branch</h2>
              <p class="branch-address" data-translation
              ...
              <p class="branch-phone"><strong>Phone:</strong> <a href="tel:+8801950935236"><?= h($phone) ?></a></p>
            </div>
            <div class="branch-media">
              <img src="/assets/images/branch-1.jpg" alt="ADPORC Main Branch" class="branch-image">
          ...
          <div class="branch">
            <div class="branch-content">
              <h2 class="h3 branch-title" data-translation
                data-lang-eng="ADPORC | Branch-2"
                data-lang-ban="ADPORC | শাখা-২">ADPORC | Branch-2</h2>
              <p class="branch-address" data-translation
                data-lang-eng="Rahman Tower, 95 Shahid Faruk Rd, South Jatrabari, Dhaka-1204"
            ...
            <div class="branch-media">
              <img src="/assets/images/branch-2.jpg" alt="ADPORC Branch 2" class="branch-image">
          ...
          <div class="branch">
            <div class="branch-content">
              <h2 class="h3 branch-title" data-translation
                data-lang-eng="ADPORC | Branch-3"
                data-lang-ban="ADPORC | শাখা-৩">ADPORC | Branch-3</h2>
              <p class="branch-address" data-translation
                data-lang-eng="10/1 Gobindopur Bazar, Shonir Akhra, South Jatrabari, Dhaka 1232"
            ...
            <div class="branch-media">
              <img src="/assets/images/branch-3.jpg" alt="ADPORC Branch 3" class="branch-image">
