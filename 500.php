 ...
 <html lang="en">
    <head>
      <!-- meta-data start -->
        ...
        <meta name="author" content="itzmehdude">
        <meta name="robots" content="index, follow">
        <link rel="canonical" href="https://adporc.com/500">
        <!-- favicon -->
        <link rel="shortcut icon" href="/adporc-icon.png" alt="ADPORC physiotherapy center logo" type="image/png">
        <link rel="apple-touch-icon" href="/adporc-icon.png">
        
        <!-- title -->
        <title>500 Server Error | ADPORC</title>
      <!-- meta-data end -->
      
      <!-- open-graph meta-tags start -->
        <meta property="og:type" content="website">
        <meta property="og:site_name" content="500 Internal Server Error | ADPORC">
        <meta property="og:title" content="Asia Digital Physiotherapy & Orthopedic Rehabilitation Center">
        <meta property="og:description" content="Oops! Something went wrong on our server. Please return to ADPORC homepage or try again later.">
        <meta property="og:url" content="https://adporc.com/500">
      ...
      <!-- css start -->
        ...
        <style>
          ...
          @import url('https://fonts.googleapis.com/css2?family=Poppins:ital,wght@300;400;500;600;700;800;900&family=Tiro+Bangla:ital,wght@0,100..900;1,100..900&display=swap');

          /* custom property */
          :root{

            /* colors */
            --light-steel-red: hsl(218, 33%, 77%);
            --royal-red-light: hsl(0, 68%, 53%);
            --flickr-red_30: hsla(0, 47%, 46%, 0.2);
            --carolina-red: hsl(0, 92%, 47%);
            --oxford-red-1: hsl(0, 100%, 0%);
            --oxford-red-2: hsl(0, 85%, 5%);
            --oxford-red-3: hsl(0, 60%, 5%);
            ...
            /* gradient color */
            --gradient: linear-gradient( 90deg, var(--carolina-red) 0%, var(--royal-red-light) 100%);

            /* typography */
            --ff-poppins: "Poppins", sans-serif;
            --ff-tiro-bangla: "Tiro Bangla", serif;
          ...
          *, *::before, *::after{
          ...
          .fa-solid {
            display: inline-block; /* ensure Font Awesome icons are visible */
          }
          a{
          ...
          body.lang-bn {
            font-family: var(--ff-tiro-bangla);
            font-size: 16px;
          }
          body.lang-eng [data-lang-ban] { font-family: var(--ff-poppins) !important; }
          body.lang-bn [data-lang-ban] { font-family: var(--ff-tiro-bangla) !important; }
          body.lang-eng [data-lang-eng] { font-family: var(--ff-poppins) !important; }
          body.lang-bn [data-lang-eng] { font-family: var(--ff-tiro-bangla) !important; }
          ...
          .h1, .h2, .h3{color: var(--oxford-red-2);}
          .h1, .h2{ font-size: var(--fs-2);}
          .h3{ font-size: var(--fs-5);}
          .btn{
            background-image: linear-gradient( var(--deg, 90deg), var(--carolina-red) 0%, var(--royal-red-light) 100%);
            color: var(--white);
            font-size: var(--fs-7);
            text-transform: uppercase;
            padding: 20px 30px;
          ...
          .btn:is(:hover, :focus){
            --deg: -90deg;
            background-image: linear-gradient(var(--deg, 90deg), var(--royal-red-light) 0%, var(--carolina-red) 100%);
            color: var(--white);
          ...
          .header-top {
            ...
            width: 100%;
            z-index: 1000;
            background-color: var(--oxford-red-1);
            color: var(--white);
            padding: 10px 0;
            font-size: 1.2rem;
            box-shadow: var(--shadow-2);
          ...
          .contact-item i {
            color: var(--royal-red-light); /* icon color */
          }
          .contact-item:hover {
            color: var(--royal-red-light); /* change text color on hover */
          }


          /* social icons and language switch */
          .header-actions {
            display: flex;
            align-items: center; /* center items vertically */
            gap: 25px; /* add spacing between social icons and language switch */
          }
          .social-list {
            display: flex;
          ...
          .header-bottom .navbar-link:hover,
          .header-bottom .navbar-link:focus {
            background: var(--royal-red-light);
            color: var(--white);
            text-decoration: none;
          }
          ...
          .popup-content {
            ...
            max-width: 500px;
            top: 0;
            font-size: 1.4rem; /* increase or decrease text size */
            padding: 20px;
          ...
          .form-group textarea:focus {
            ...
            box-shadow: 0 0 5px var(--royal-red-light);
          }
          ...
          .appointment-form .btn:hover {
            background-image: linear-gradient(90deg, var(--royal-red-light) 0%, var(--carolina-red) 100%);
          }
          ...
          .section-text #blog-bn ol li, .about #blog-bn ol li  {
          ...
          .branch-address, .branch-phone a  {
            color: var(--royal-red-light);
            text-decoration: none;
          }
          .branch-address, .branch-phone a:hover {
            text-decoration: none;
          }
          /* responsive design */
          ...
          .doctor-card:is(:hover, :focus-within) .card-title{ color: var(--royal-red-light);}
          ...
          /* cta */
          .cta{ background-color: var(--oxford-red-1);}
          ...
          .blog-card .card-title:hover::after {
            transform: scaleX(1);
          }
          ...
          /* team page start */
              .profile-wrapper { margin: 50px auto; }
              ...
              .tag {
                ...
                color: var(--royal-red-light);
                font-weight: var(--fw-600);
                border: 1px solid var(--royal-red-light);
                font-size: 1.3rem;
              }
              .quick-links {
                margin-top: 12px;
          ...
          .marquee {
            ...
            align-items: center;
            gap: 50px;
            animation: marquee 15s linear infinite; /* animation for continuous scrolling */
            white-space: nowrap;
          }
          .marquee span {
            display: flex;
          ...
          /* footer */
          .footer-top{
            background-color: var(--oxford-red-2);
            color: var(--light-steel-red);
          }
          ...
          .footer-left {
            ...
            flex-direction: column;
            align-items: flex-start;
            gap: 18px; /* increased gap between icons & copyright */
          }
          /* social icons row */
          ...
          .footer-bottom .social-link {
            padding: 11px;
            background-color: var(--flickr-red_30);
            color: var(--white);
            font-size: 15px;
            border-radius: 50%;
            transition: all 0.3s ease;
          }
          .footer-bottom .social-link:is(:hover, :focus) {
            background-image: var(--gradient);
            transform: scale(1.1);
          }
          /* copyright text */
          ...
          .footer-bottom .developer a{
            ...
            text-decoration: none;
            text-align: right;
            margin-left: auto; /* this pushes it as far right as possible */
            align-self: flex-end; /* aligns with bottom of icons block */
            cursor: pointer;
          }
          .footer-bottom .developer a:hover,
          .footer-bottom .developer a:focus,
          .footer-bottom .developer a:active {
          ...
          @media (max-width: 500px) {
            ...
            .header-bottom .container .logo img {
              width: 65px; /* reduced logo size for smaller screens */
            }
            .header-bottom .container .logo span {
              font-size: 16px;
            }
            ...
            .blog-card .card-badge .time{
              padding: 6px 8px;
              font-size: 12px;
            }
          }

          /* for smaller than 767px screen */
          @media (max-width: 767px) {
            ...
            .header-top .contact-list .contact-item:first-child {
              display: none; /* hide the address in the top navbar */
            }
            .header-top .container {
              justify-content: space-between;
            }
          ...
          /* for screens between 501px and 767px */
          ...
          /* for screens between 501px and 991px */
          ...
          @media (min-width: 992px){
            ...
            .header-top .social-link:is(:hover, :focus){ color: var(--royal-red-light);}
            ...
            .header-bottom.active{ top: -100px;}
            ...
            .navbar-link:is(:hover, :focus){ color: var(--royal-red-light);}
            .header-bottom .btn{
              display: block;
              padding: 15px 20px;
            }
          ...
          /* for screens between 990px and 1200px */
        ...
        <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@300;400;500;600;700;800;900&family=Tiro+Bangla:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
      <!-- css end -->
      ...
      <script type="application/ld+json">
        {
          ...
          "@graph": [
            ...
            {
              "@type": "ErrorPage",
              "name": "500 Internal Server Error | ADPORC",
              "url": "https://adporc.com/500",
              "description": "Oops! Something went wrong on our server. Please return to ADPORC homepage or try again later.", 
    ...
    <body id="top">
      ...
      <main>
        <!-- 500-error -->
        <section class="section error" id="error" aria-label="error"
          style="min-height:60vh;display:flex;flex-direction:column;align-items:center;justify-content:center;">
          <img src="/adporc-logo-rounded.png" alt="ADPORC logo" style="width:25%;margin-bottom:20px;">
          <h1 data-translation style="font-size:4rem;color:var(--carolina-red);margin-bottom:10px;"
            data-lang-eng="500" 
            data-lang-ban="৫০০">
          </h1>
          <h2 data-translation style="color:var(--oxford-red-1);margin-bottom:20px;"
            data-lang-eng="Something Went Wrong" 
            data-lang-ban="কিছু ভুল হয়েছে">
          </h2>
          <p class="card-text" data-translation style="margin-bottom:20px;"
            data-lang-eng="Oops! Something went wrong on our server. Please return to the homepage or try again later." 
            data-lang-ban="দুঃখিত! আমাদের সার্ভারে কিছু ভুল হয়েছে। অনুগ্রহ করে হোমপেজ এ ফিরে যান অথবা কিছুক্ষণ পরে আবার চেষ্টা করুন।">
          </p>

          <a href="/home.html" class="btn" data-translation style="margin-top:20px;"
            data-lang-eng="Go to Home" 
            data-lang-ban="হোমপেজে ফিরে যান">
          </a>
        </section>
        <!-- FAQ section -->
        ...
        document.addEventListener("DOMContentLoaded", function() {
          ...
          if (phoneForm) {
            phoneForm.addEventListener("submit", function(e) {
              ...
              fetch("https://script.google.com/macros/s/AKfycbyyhyKWODeLPB9fDxxE7MisAK3c4mG5MfgXImHRyfk3MCkV2AOFSv-9zXhfvmJEznlq0Q/exec", { 
                method: "POST", mode: "no-cors", headers: { "Content-Type": "application/x-www-form-urlencoded" }, body: formData })
                .then((response) => {
