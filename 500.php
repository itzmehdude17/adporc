...
<html lang="en">
  <head>
    ...
    <title>500 Internal Server Error | ADPORC</title>
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="ADPORC">
    <meta property="og:title" content="500 Internal Server Error | ADPORC">
    <meta property="og:description" content="An unexpected error occurred. Please try again later.">
    <!-- css -->
  ...
  <body id="top">
    ...
    <!-- main -->
    <main>
      <section class="section error" id="error" aria-label="500 error"
        ...
        <h1 data-translation
          ...
          data-lang-eng="500" data-lang-ban="৫০০">500</h1>
        <h2 data-translation
          style="font-size:2.4rem;color:var(--oxford-red-1);margin:10px 0 20px;"
          data-lang-eng="Internal Server Error"
          data-lang-ban="সার্ভার ত্রুটি">Internal Server Error</h2>
        <p class="card-text" data-translation
          style="max-width:500px;margin-bottom:30px;"
          data-lang-eng="Oops! Something went wrong on our end. Please try again in a moment."
          data-lang-ban="দুঃখিত, আমাদের সার্ভারে একটি সমস্যা হয়েছে। অনুগ্রহ করে কিছুক্ষণ পরে আবার চেষ্টা করুন।">
